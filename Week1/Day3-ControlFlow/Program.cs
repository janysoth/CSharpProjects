...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (!exitProgram)
        {
            ...
            Console.WriteLine(); // Space between menu iterations
        }
    }
    ...
    // ============================================================
    static void RunEvenOddExercise()
    {
        Console.WriteLine("=== Exercise 1: Even or Odd ===");
        Console.Write("Enter a number: ");
        int number = int.Parse(Console.ReadLine());

        // Using if-else to determine even or odd
        if (number % 2 == 0)
        {
